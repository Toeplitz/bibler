#!/usr/bin/env python3
"""A simple command line tool to parse bibtex files and launch
...
import subprocess
import bibtexparser
__author__ = "Martin Sarajaervi"
__copyright__ = "Copyright 2016"
__license__ = "LGPL"
__version__ = "3.0.0"
__maintainer__ = "Martin Sarajaervi"
__email__ = "martin.sarajaervi@gmail.com"
...
def launch_viewer(fname):
    if os.path.isfile(fname) == 1:
        ...
        if request.status_code == 200:
            ...
            cmd_str = "nohup " + WEB_VIEWER + " " + fname + " >/dev/null 2>&1 &"
        else:
...
if __name__ == '__main__':
    ...
    if not os.path.isfile(bibfile):
        print("Error: Bibtex file not found '%s'" % bibfile)
        sys.exit(-1)
    else:
